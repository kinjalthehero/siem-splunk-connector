...
public class AttackData {
    ...
    // URL decode and Base64 decode the rule data
    public void processRaw() throws UnsupportedEncodingException {
        ...
        // Get the max size of the fields in each of the rules categories
        ...
        for (int i = 0; i < maxSize; i++) {
            ...
            // Add processed rules in the property of this class
            Rule newRule = new Rule(((i < rules.size()) ? rules.get(i) : ""),
                    ((i < ruleVersions.size()) ? ruleVersions.get(i) : ""),
                    ((i < ruleMessages.size()) ? ruleMessages.get(i) : ""),
                    ((i < ruleTags.size()) ? ruleTags.get(i) : ""),
                    ((i < ruleData.size()) ? ruleData.get(i) : ""),
                    ((i < ruleSelectors.size()) ? ruleSelectors.get(i) : ""),
